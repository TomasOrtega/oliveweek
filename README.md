...
The planning catalogue includes 246 weighed recipes: 26 adaptations of public-domain community recipes, 20 recipes from the author, and an open-source pack of 100 breakfasts and 100 snacks. The author's 20 imported recipes use attributed Wikimedia Commons photographs; every recipe in the open planning pack has its own attributed photograph sourced through Openverse or Wikimedia Commons. All photographs are locally bundled. Provenance, exclusions, licenses and checksums are recorded in [`vendor/based-cooking/PROVENANCE.json`](vendor/based-cooking/PROVENANCE.json), [`vendor/public-domain-recipes/PROVENANCE.json`](vendor/public-domain-recipes/PROVENANCE.json), [`vendor/open-recipe-archive/PROVENANCE.json`](vendor/open-recipe-archive/PROVENANCE.json), [`data/spreadsheet-photo-sources.json`](data/spreadsheet-photo-sources.json), [`data/open-planning-photo-sources.json`](data/open-planning-photo-sources.json) and [`NOTICE.md`](NOTICE.md).
